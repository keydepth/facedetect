...
#            cv2.rectangle(image, tuple(rect[0:2]), tuple(rect[0:2]+rect[2:4]), (255, 0, 0), thickness=3)
            cv2.rectangle(image, tuple(rect[0:2]), (rect[0]+rect[2],rect[1]+rect[2]), (255, 0, 0), thickness=3)
            img = image[rect[1]:rect[1]+rect[2],rect[0]:rect[0]+rect[2]]
            if image.shape[0]<64:
                print("too small")
                continue
...
model = load_model('./my_model-d3-epoch100.h5')
